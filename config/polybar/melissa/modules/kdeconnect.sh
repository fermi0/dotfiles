...
COLOR_BATTERY_90='#33ff00'         # Battery >= 90
COLOR_BATTERY_80='#78d162'         # Battery >= 80
COLOR_BATTERY_70='#8fd162'         # Battery >= 70
COLOR_BATTERY_60='#aed162'         # Battery >= 60
COLOR_BATTERY_50='#d1b462'         # Battery >= 50
COLOR_BATTERY_LOW='#bf6652'        # Battery <  50
