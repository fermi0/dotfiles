...
# Flat layout: everything lives in configs/

# Modify this config file for default terminal and EDITOR
config_file="$HOME/.config/hypr/configs/AppDefaults.conf"
...
main() {
    ...
    case "$choice" in
    	"Edit User Defaults") file="$configs/AppDefaults.conf" ;;
        ...
        "Edit User Settings") file="$configs/SystemSettings.conf"; show_info "Editing default settings. edit configs/SystemSettings.conf directly." ;;
