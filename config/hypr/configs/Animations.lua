-- Generated by Animations.sh from 01-artemsmaznov
...
hl.curve("default", { type = "bezier", points = { {0, 0}, {1, 1} } })hl.config({
    animations = {
        enabled = true,
    },
})
...
hl.curve("easeInQuart", {
    type = "bezier",
    points = { {0.5, 0}, {0.75, 0} },
})
hl.curve("easeInQuint", {
    type = "bezier",
...
hl.curve("easeInOutQuart", {
    type = "bezier",
    points = { {0.77, 0}, {0.23, 1} },
})
hl.curve("easeInOutQuint", {
    type = "bezier",
    points = { {0.86, 0}, {0.14, 1} },
})
...
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 7, bezier = "easeOutQuint", style = "slidefade 10%" })
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 5, bezier = "easeOutQuint", style = "slidevert" })
hl.animation({ leaf = "specialWorkspaceIn", enabled = true, speed = 5, bezier = "easeOutQuint", style = "slidevert" })
hl.animation({ leaf = "specialWorkspaceOut", enabled = true, speed = 5, bezier = "easeInOutQuint", style = "slidevert" })
hl.animation({ leaf = "fadeSwitch", enabled = true, speed = 5, bezier = "easeInOutQuint" })
hl.animation({ leaf = "fadeShadow", enabled = true, speed = 5, bezier = "easeInOutQuint" })
hl.animation({ leaf = "fadeDim", enabled = true, speed = 7, bezier = "easeInOutQuint" })
hl.animation({ leaf = "fadeLayers", enabled = true, speed = 5, bezier = "easeOutQuint" })
